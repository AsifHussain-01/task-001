            ...
            <div className='w-full max-[200px] '>
                ...
                <div className='mt-5 max-w-[1024px] w-full h-full flex  content-center'>
                    <div className='max-w-[1024px] max-h-[48px]'>
                        ...
                        <div>
                        < button className='w-[119px] h-[48px] bg-gray-200 rounded-[4px] pl-[32px] pr-[32px] pt-[16px] pb-[16px] bg-blue-600 ml-[28px] text-[16px] leading-4 font-koh Santepheap font-normal hover: bg-blue-100'>Submit</button>
                        </div>
                    <div>
