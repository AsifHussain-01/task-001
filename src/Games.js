    ...
    return (
        <div className='container w-full max-w-[1024px] h-full max-h-[1555px] mx-auto justify-center'>
            ...
            <div className='w-full max-[200px] '>
                <div>
                    <div className='max-w-[1024px] max-h-[24px] mx-auto mt-[0px]'>
                ...
                <div className='w-[1080px] h-[744px] bg-orange-100 border-orange-600 mt-[40px] p-[48px] rounded-[24px] mb-[40px]'>
                    {/* box one  */}
